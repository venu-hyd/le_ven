        ...
        if (order_id_val != "undefined" && order_id_val != null) 
		{
                ...
                success: function(result) 
				{
					   ...
					   taxDetailsData=null;
                        ...
                        toppingshtml += "<i> <span id=" + subtotal + "><span style='border:none' class='WebRupee'>&#x20B9;</span> " + subtotalfixed + "</span></i>";
                                ...
                                if (toppings.length >= 1 || crusts.length >= 1) {
								  ...
								  $.each(crustings_quantitywise, function(i, text) {
                                    ...
                                    priceDetails = "" +
                                        ...
                                        "<p style='" + discount_div_style + "margin:10px 10px 0 0;' class='discount-div'>" + discount_div.replace("Rs", "<span class='WebRupee'>&#x20B9;</span>") + "</p>" +
                                        "<p style='display:" + display + "; margin:10px 10px 0 0;' class='pull-right total-rs text-strikethrough'><span class='WebRupee'>&#x20B9;</span>" + strikeprice_cutoff + "</p>" +
                                        ...
                                        "<p style='margin:10px 10px 0 0;' class='pull-right total-rs total_204 '><span class='WebRupee'>&#x20B9;</span>" + price_without_additions + "</p>" +
                                        //"<p style='display:"+display+"; margin:10px 10px 0 0;' class='pull-right total-rs text-strikethrough'><span class='WebRupee'>&#x20B9;</span>" + strikeprice_cutoff  + "</p>" +
                                        "</div><div><p style='display:" + adntsclassstyle + "; margin:10px 10px 0 0;' class='pull-right'>Additions <span class='WebRupee'>&#x20B9;</span>" + additions + "</p></div></div>";
                        ...
                        for (var h = 0; h < orderOfdisplay.length; h++) {
								if(taxDetailsData[orderOfdisplay[h]])
								{
                                    if ((taxDetailsData[orderOfdisplay[h]] != '0.0') && (taxDetailsData[orderOfdisplay[h]] != '0')) {
                                        ...
                                        toppingshtml += '<td width="50%" valign="middle" align="right"><span class="WebRupee">&#x20B9;</span>  ' + parseFloat(taxDetailsData[orderOfdisplay[h]]).toFixed(2) + '</td></tr>';
                                    }
                        ...
                        toppingshtml += '<td valign="middle" align="right"> <span class="WebRupee">&#x20B9;</span>  ' + parseFloat(subtotal).toFixed(2) + '</td></tr>';
                        toppingshtml += '</table>';
