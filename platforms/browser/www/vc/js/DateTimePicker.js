		...
		DateTimePicker.prototype = {
			...
			_modifyPicker: function()
			{
				...
				for(var iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++)
				{
					...
					sDTPickerComp += "<input type='text' onkeydown='return false' onkeyup='return false'  class='dtpicker-compValue'  id='in' readonly ></input>";
			...
			_addEventHandlersForPicker: function()
			{
				...
				$(dtPickerObj.element).find(".minutes .increment").click(function(e)
				{
					...
					dtPickerObj.dataObject.iCurrentMinutes=dtPickerObj.dataObject.iCurrentMinutes+15;
