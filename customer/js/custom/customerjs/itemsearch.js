...
<p style="display:' + showstrikeandoff + ';">'+currency+' <strike class="strikeprice">' + priceInStrike + '</strike> <span style="display:' + ruppesty + ';" class="tobeappend offRed">' + tobeappend + '</span> <span class="discprice offRed">' + discount_price + '</span> <span class="offRed" style="display:' + ruppesty + ';">' + textdata + '</span> <span class="offRed" style="display:' + discsty + ';">' + textdata + '</span> </p>\
                                                        <p>'+currency+' <b class="sellprice"> ' + selling_price + '</b></p>\
                                                        <p class= "additionsclassstyle" style="display:' + addnsstyle + ';"><span >Additions:'+currency+'</span>  <b class="additions">' + totalcost + '</b></p>\
                                                    </div>\
