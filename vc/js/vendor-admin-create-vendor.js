       ...
       // specialKeys.push(46); //Delete
        ...
        $(function () 
        {
		 ...
		 //praveen
		  ...
		  var ret = (((keyCode >= 48 && keyCode <= 57) ||keyCode==32||keyCode==40 ||keyCode==58  ||keyCode==41 || keyCode==198  || keyCode==216 || keyCode==197 || keyCode==229 || keyCode==230 || keyCode==248 || keyCode==38||keyCode==39   || (keyCode >= 65 && keyCode <= 90) || (keyCode >= 97 && keyCode <= 122) || (specialKeys.indexOf(keyCode) != -1 && e.charCode == keyCode) ||(keysToAllow.indexOf(keyCode) != -1 && keyCode == e.keyCode) ) );
		  //end
