...
$.widget( "ui.accordion", {
	...
	_destroy: function() {
		...
		// clean up headers
		this.headers
			.removeClass( "ui-accordion-header ui-accordion-header-active ui-helper-reset ui-state-default ui-state-active ui-state-disabled" )
			.removeAttr( "role" )
		...
		contents = this.headers.next()
			...
			.removeClass( "ui-helper-reset ui-widget-content  ui-accordion-content ui-accordion-content-active ui-state-disabled" )
			.each(function() {
				if ( /^ui-accordion/.test( this.id ) ) {
					this.removeAttribute( "id" );
				}
